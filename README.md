...
Not eligible, provide reason why they are not eligible and show other resources. Store the other resources in a database as a template so that HOS can change it.

Eligible, show the programs that they qualify for along with projected wait times (obtain wait information from a database)

Previous and Next buttons (like on Pickup App)

Address of Property.

Mailing Address (checkbox same as property address).
